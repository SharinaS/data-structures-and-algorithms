...
const extractAbilities = (arr) => {
  ...
  return newArray;
//console.log(snorlaxAbilities.abilities[0].ability.name);
};
...
const extractStats = (arr) => {
  // Solution code here...
  // {stat name, total}
  // total = effort + basestat
  const nameTotal = arr.map( value => {
      //console.log({'total': value.effort + value. baseStat});
